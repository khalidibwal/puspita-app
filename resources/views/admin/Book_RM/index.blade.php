<x-app-layout>
    ...
    <a href="{{ route('book_rm.create') }}" class="edit-btn mb-4">
    ...
    <!-- Search Form -->
    <form action="{{ route('book_rm.index') }}" method="GET" class="mb-4" style="margin-top: 20px;">
        ...
        <tbody>
            @foreach ($rekamMedis as $rekam)
                <tr>
                    ...
                    <td>{{ $rekam->userlogin->name ?? 'N/A' }}</td> <!-- Updated to use ApiUser model -->
                    ...
                    <td>
                        <a href="{{ route('book_rm.edit', $rekam->idRekamMedis) }}" class="edit-btn">Edit</a>
                        <form action="{{ route('book_rm.destroy', $rekam->idRekamMedis) }}" method="POST" style="display:inline;" class="delete-form">
                            @csrf
                            @method('DELETE')
